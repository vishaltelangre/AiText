...
import { DEFAULT_AI_PROVIDERS_CONFIGS, STORAGE_KEYS } from "@/constants";
import { getAiProviderConfig, getStorageData } from "@/utils";
...
const Popup = () => {
  ...
  const activeProviderConfig = getAiProviderConfig(
    aiProvidersConfigs.activeProvider,
    aiProvidersConfigs
  );
    ...
    <div className="ait-root">
      <div className="ait-w-[320px] ait-p-4">
        ...
        <div className="ait-mt-4 ait-space-y-4 ait-rounded-lg ait-border ait-border-gray-200 ait-p-4">
          ...
          {error ? <div className="ait-text-center ait-text-gray-500">{error}</div> : null}
        </div>
